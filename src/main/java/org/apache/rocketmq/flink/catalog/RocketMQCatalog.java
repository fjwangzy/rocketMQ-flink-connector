...
public class RocketMQCatalog extends AbstractCatalog {
	...
	public RocketMQCatalog(String catalogName, String database, String namesrvAddr, String schemaRegistryUrl) {
		...
		checkArgument(!isNullOrWhitespaceOnly(schemaRegistryUrl), "schemaRegistryUrl cannot be null or empty");
	...
	public void open() throws CatalogException {
		if (mqAdminExt == null) {
			try {
				...
				throw new CatalogException("Failed to create RocketMQ admin using :" + namesrvAddr, e);
			}
		}
	...
	public List<String> listTables(String databaseName) throws DatabaseNotExistException, CatalogException {
		...
		try {
			...
			throw new CatalogException(
					String.format("Failed to get topics of namespace %s from schema registry client.", databaseName),
					e);
		}
	}
	...
	public CatalogBaseTable getTable(ObjectPath tablePath) throws TableNotExistException, CatalogException {
		...
		try {
			...
			throw new CatalogException(String.format("Failed to get schema of table %s from schema registry client.",
	...
	public List<CatalogPartitionSpec> listPartitions(ObjectPath tablePath)
		...
		try {
			...
			return topicStatsTable.getOffsetTable()
				.keySet()
				.stream()
				.map(topicOffset -> new CatalogPartitionSpec(new HashMap<String, String>(1) {
					{
						String queueId = String.valueOf(topicOffset.getQueueId());
			...
			throw new CatalogException(String.format("Failed to list partitions of table %s by defaultMQAdminExt.",
					tablePath.getFullName()), e);
		}
	}
	...
	public boolean partitionExists(ObjectPath tablePath, CatalogPartitionSpec partitionSpec) throws CatalogException {
		try {
			...
			throw new CatalogException(
					String.format("Failed to judge partition %s of table %s exists by defaultMQAdminExt.",
