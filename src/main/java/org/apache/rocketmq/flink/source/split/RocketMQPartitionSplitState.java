...
public class RocketMQPartitionSplitState extends RocketMQPartitionSplit {
	...
	public RocketMQPartitionSplitState(RocketMQPartitionSplit partitionSplit) {
		super(partitionSplit.getTopic(), partitionSplit.getBroker(), partitionSplit.getPartition(),
				partitionSplit.getStartingOffset(), partitionSplit.getStoppingTimestamp());
	...
	/**
	 * Use the current offset as the starting offset to create a new
	 * RocketMQPartitionSplit.
	 * @return a new RocketMQPartitionSplit which uses the current offset as its starting
	 * offset.
	 */
	public RocketMQPartitionSplit toRocketMQPartitionSplit() {
		return new RocketMQPartitionSplit(getTopic(), getBroker(), getPartition(), getCurrentOffset(),
