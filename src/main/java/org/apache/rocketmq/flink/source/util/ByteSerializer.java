...
public class ByteSerializer {
	...
	public enum ValueType {
		...
		V_ByteArray, V_String, V_Byte, V_Short, V_Integer, V_Long, V_Float, V_Double, V_Boolean, V_Timestamp, V_Date,
		V_Time, V_BigDecimal, V_BigInteger, V_LocalDateTime, V_LocalDate, V_Duration, V_LocalTime, V_Period,
		V_OffsetDateTime, Unsupported
