...
public class RocketMQRowDeserializationSchemaTest {
	...
	public void testDeserialize() {
		TableSchema tableSchema = new TableSchema.Builder().field("int", DataTypes.INT())
			...
			.build();
		RocketMQRowDeserializationSchema recordDeserializer = new RocketMQRowDeserializationSchema(tableSchema,
		...
		MessageExt firstMsg = new MessageExt(1, System.currentTimeMillis(),
		...
		MessageExt secondMsg = new MessageExt(1, System.currentTimeMillis(),
				InetSocketAddress.createUnresolved("localhost", 8081), System.currentTimeMillis(),
				InetSocketAddress.createUnresolved("localhost", 8087), "284019387");
		secondMsg.setBody("test_deserializer_raw_messages_2".getBytes());
		MessageExt thirdMsg = new MessageExt(1, System.currentTimeMillis(),
				InetSocketAddress.createUnresolved("localhost", 8082), System.currentTimeMillis(),
				InetSocketAddress.createUnresolved("localhost", 8086), "384019387");
