...
public class RocketMQOptionsUtilTest {
	...
	public void testParseSpecificOffsets() {
		...
		Map<MessageQueue, Long> actual = RocketMQOptionsUtil.parseSpecificOffsets(specificOffsetsStr, topic);
	...
	public void testValidateStartUpMode() {
		...
		conf.set(OPTIONAL_SCAN_STARTUP_SPECIFIC_OFFSETS, "broker:a,queue:0,offset:123;broker:a,queue:1,offset:38");
		RocketMQOptionsUtil.validateStartUpMode(conf);
		// timestamp
